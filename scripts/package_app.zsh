...
APP_NAME="空间文件夹 2.3.1 测试版"
APP="$RELEASE_DIR/$APP_NAME.app"
ZIP="$RELEASE_DIR/空间文件夹-v2.3.1-测试版.zip"
SDK="/Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk"
CACHE="$ROOT/.build/module-cache"
SCRATCH="$ROOT/.build/2.3.1-release"
...
VERIFY_DIR="$(mktemp -d /tmp/spatial-folder-2.3.1-verify.XXXXXX)"
